      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Agnira MUN 2025, in collaboration with East Point School, presents an exceptional platform
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative p-8 bg-gradient-to-br from-[#8B0000]/20 to-[#1a0a0f]/50 backdrop-blur-sm rounded-2xl border border-[#FFD700]/10 hover:border-[#FFD700]/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[#FFD700]/20"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFD700]/0 to-[#FFD700]/0 group-hover:from-[#FFD700]/5 group-hover:to-[#FFD700]/10 rounded-2xl transition-all duration-500" />

                <div className="relative">
                  <div className="mb-6 relative">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#8B0000] to-[#A52A2A] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <Icon className="w-8 h-8 text-[#FFD700]" />
                    </div>
                    <div className="absolute inset-0 bg-[#FFD700] blur-xl opacity-20 group-hover:opacity-40 transition-opacity" />
                  </div>
        ...
        <div className="bg-gradient-to-r from-[#8B0000]/20 via-[#A52A2A]/20 to-[#8B0000]/20 backdrop-blur-sm rounded-3xl p-12 border border-[#FFD700]/20">
