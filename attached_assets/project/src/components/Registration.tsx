      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join Agnira MUN 2025 and be part of an exceptional diplomatic experience.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative p-8 text-center">
                  <div className="mb-6 flex justify-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#8B0000] to-[#A52A2A] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative">
                  <div className="group relative overflow-hidden rounded-2xl border border-[#FFD700]/20 hover:border-[#FFD700]/40 transition-all duration-500 h-full">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#8B0000]/30 to-[#1a0a0f]/50 backdrop-blur-sm" />
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
                      <div className="w-6 h-0.5 bg-gradient-to-r from-[#FFD700] to-transparent" />
                    </div>
                  )}
                </div>
              );
        ...
        <div className="bg-gradient-to-br from-[#8B0000]/30 to-[#1a0a0f]/50 backdrop-blur-sm rounded-3xl p-8 border border-[#FFD700]/20 mb-12">
        ...
        <div className="text-center">
          <a
            href="#"
            className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-[#8B0000] to-[#A52A2A] text-white text-lg font-semibold rounded-xl hover:shadow-2xl hover:shadow-[#FFD700]/30 hover:scale-105 transition-all duration-300 group"
          >
